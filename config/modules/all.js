...
module.exports = async function (app, env) {
    ...
    await app.module.use(view_1.ViewModule.for({ viewEngine: view_1.ViewEngines.nunjucks }), validator_1.ValidationModule, mongo_1.MongoModule.for({ connection: env.mongo }));
};
